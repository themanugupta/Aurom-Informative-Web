      ...
      {isLgScreen ? (
        ...
        >
          <div className="up flex flex-col ">
            <div className="heading text-[48px]   pb-[30px] border-b-[2px] border-[#808080] font-semibold">
              <span className="text-[#808080]">The One Stop</span>{" "}
              <span className="text-[#d9d9d9]">Solution</span>
            </div>
            <div className="line h-[1px] text-[#808080] w-[500px] "> </div>
            <span className="text-[#d9d9d9] lg:text-[24px] md:text-[15px] pt-[30px] font-normal">
              At Aurom, we believe everyone deserves a safe space to share their
              feelings. Our mission is to connect you with compassionate
              listeners who are here to support and understand you.
            </span>
          </div>
          <div className="down flex flex-col gap-[24px]">
            <div className="heading lg:text-[32px] md:text-[20px]  font-semibold">
              <span className="text-[#808080]">What can you</span>{" "}
              <span className="text-[#d9d9d9]">Expect</span>
            </div>
        ...
        <div>
          <div className="up flex px-3 flex-col ">
            ...
            <span className="text-[#d9d9d9] text-[14px] pt-[15px] pb-4 font-normal">
              At Aurom, we believe everyone deserves a safe space to share their
              feelings. Our mission is to connect you with compassionate
              listeners who are here to support and understand you.
            </span>
