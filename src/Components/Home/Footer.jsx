...
function Footer() {
  ...
  return (
    <div className="relative">
      ...
      <div
        className={`content absolute top-0 w-full h-full flex flex-col justify-center items-center ${
          isLgScreen ? "lg:gap-16" : "md:gap-8"
        }`}
      >
        <img
          className={`object-contain ${isLgScreen ? "lg:w-40" : "w-[120px]"}`}
          src="Logo.svg"
          alt=""
        />
        <div className="flex flex-col justify-between items-center">
          <span
            className={`text-[#d9d9d9] font-semibold ${
          ...
          <div>
            <span
              className={`${
                isLgScreen ? "lg:text-[24px]" : "text-[14px]"
              } text-[#808080]`}
            >
              {" "}
              Your safe place to{" "}
